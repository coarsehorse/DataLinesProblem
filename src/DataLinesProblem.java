...
public class DataLinesProblem {
    ...
    public static void main(String[] args) {
        List<DataLine> buffer = new ArrayList<>(); // data lines(C) accumulator
    ...
    // Transform stream of (query, lines) to the stream of results
    private static Function<Pair<DataLine, List<DataLine>>, String> pair2result = pair -> {
        DataLine query = pair.getKey();
        List<DataLine> dLines = pair.getValue();

        // Apply filters from the query to dLines
